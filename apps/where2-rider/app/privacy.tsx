...
const SECTIONS = [
  {
    ...
    body: "When you use Where2, we collect your name, email, phone number, and location data to provide ride services. We also collect payment information processed securely through our payment partners.",
  },
  {
    title: "How We Use Your Information",
    body: "Your information is used to connect you with drivers, calculate fares, ensure safety during rides, and improve our services. Location data is used for real-time ride tracking and route optimization.",
  },
  {
    title: "Data Sharing",
